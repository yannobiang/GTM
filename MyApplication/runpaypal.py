...
static_folder='/home/princeobiang/nancy_projet/nancy_creation/MyApplication/test/static/')
paypal.configure({
...
def paypal_payment(montant):
    ...
    payment = paypal.Payment({
        ...
        # Redirect URLs
        "redirect_urls": {
            "return_url": "http://127.0.0.1:2020/paypal_Return?success=true",
            "cancel_url": "http://127.0.0.1:2020/paypal_Return?cancel=true"},
